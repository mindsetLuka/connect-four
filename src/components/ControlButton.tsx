...
export default function ControlButton({ label, ...props }: ControlButtonProps) {
  return (
    <button
      {...props}
      className={`px-3 py-2 bg-[#E7DBFD] hover:bg-white disabled:bg-gray-500 disabled:cursor-not-allowed
        text-black font-semibold rounded-lg transition-all text-xs md:text-sm flex-1 min-w-[120px]
